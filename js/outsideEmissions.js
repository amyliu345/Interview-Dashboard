...
//Travel time, distance, emissions, etc///////
    ...
    var activityToAbbrev = {},
        i,
        activity = ["Home","Work","Work-Related Business","Education","Pick Up/Drop Off","Personal Errand/Task","Meal/Eating Break","Shopping","Social","Recreation","Entertainment","Sports/Exercise","To Accompany Someone","Other Home","Medical/Dental (Self)","Other (stop)","Change Mode/Transfer","Car/Van","Taxi","Bus","Other (mode)","Motorcycle/Scooter","LRT/MRT","Bicycle","Foot"],
        abbrev = ["Home", "Work", "Business","Edu.","Pick Up","Errand","Meal","Shop","Social","Rec.","Entertain.","Exercise","Accompany","Other","Medical","Other","Transfer","Car","Taxi","Bus","Other","Motorcycle","LRT/MRT","Bike","Foot"]

    for (i = 0; i < activity.length; i++) {
        activityToAbbrev[activity[i]] = abbrev[i];
    };

    var legend_text = ["Work","Work-Related Business","Education","Pick Up/Drop Off"]
    var legend_second_text = ["Personal Errand/Task","Meal/Eating Break","Shopping","Social"]

    d3.json("data/outsideEmissions.json", function(error, dataset) {  
...
// ///ref line code here
      drawRefLine(svg, 4, "Neighbors");
     // drawRefLine(svg, 6, "World");
      ...
      svg.append('text')
          ...
          .attr('x', 0)
          .attr('y', height+45)
          .text('Out-of-home Activities Emissions');
