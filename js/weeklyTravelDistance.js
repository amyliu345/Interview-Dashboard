$(document).ready( function() {
  ...
  var svg = d3.select("#weeklyTravelDistance").append("svg")
     ...
     // .attr("class", "bar2")
      ...
      .attr("y", function(d) {
        tip1.html(function(d) {
          return "<span style='color:white'>" + "Neighbors: " + "<br>" + d.mode+ " " + d.neighbor + " km" + "</span>";
        })
        return y(d.neighbor);
      })
    ...
    var bar2 = g.append("rect")
      ...
      .attr("y", function(d) {
        tip2.html(function(d) {
          return "<span style='color:white'>" + "You: " + "<br>" + d.mode+ " " + d.user + " km" + "</span>";
        })
