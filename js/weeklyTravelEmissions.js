$(document).ready( function() {
  ...
  var svg = d3.select("#weeklyTravelEmissions").append("svg")
  ...
  d3.csv("data/weeklyTravelEmissions.csv", type, function(error, data) {
    // console.log(data)
    ...
    var bar1 = g.append("rect")
      ...
      .attr("y", function(d) {
        tip1.html(function(d) {
          return "<span style='color:white'>" + "Neighbors: " + "<br>" + d.mode+ " " + d.neighbor + " kg" + "</span>";
        })
        return y(d.neighbor);
      })
    ...
    var bar2 = g.append("rect")
      ...
      .attr("y", function(d) {
        tip2.html(function(d) {
          return "<span style='color:white'>" + "You: " + "<br>" + d.mode+ " " + d.user + " kg" + "</span>";
        })
